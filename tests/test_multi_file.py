...
class TestMultiFile(unittest.TestCase):
    def test_combine_and_dedupe_two_files(self):
        ...
        run_deduplication_multi(['test_cases/multi_file_part1.xml', 'test_cases/multi_file_part2.xml'])
    ...
    def test_works_with_flags(self):
        ...
        run_deduplication_multi(['test_cases/multi_file_whitespace_part1.xml', 'test_cases/multi_file_whitespace_part2.xml'],
